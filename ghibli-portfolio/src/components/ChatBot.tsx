      ...
      <div className="fixed bottom-6 right-6 z-50">
        <div className="relative tooltip-wrapper">
          ...
          <button
            ...
            className="w-14 h-14 rounded-full shadow-lg shadow-accent/20 flex items-center justify-center transition-all duration-300 hover:scale-105 overflow-hidden border-2 border-accent/40"
            aria-label="AI Chat"
          >
            {open ? (
